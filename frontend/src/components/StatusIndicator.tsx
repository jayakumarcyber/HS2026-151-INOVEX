  ...
  return (
    <div className="flex items-center gap-3">
      ...
      {health.status === 'connected' && (
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-sm shadow-emerald-500/10">
          ...
          {health.latencyMs !== null && (
            <span className="text-emerald-500/80 font-mono">({health.latencyMs}ms)</span>
          )}
        </div>
      )}
